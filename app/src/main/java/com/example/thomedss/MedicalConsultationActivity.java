...
public class MedicalConsultationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<ConsultationModel> appointments = db.getAppointment(currentUser.getId());
...
//
//        patientName = findViewById(R.id.textView0);
//        dateCreated = findViewById(R.id.textView1_2);
//        timeQueued = findViewById(R.id.textView2_2);
//        queueStatus = findViewById(R.id.textView3_2);
//        attendingDoctor = findViewById(R.id.textView4_2);
//
//        DatabaseHelper db = new DatabaseHelper(MedicalConsultationActivity.this);
//        ArrayList<ConsultationModel> appointments = db.getAppointment(currentUser.getId());
//
//        for(ConsultationModel cm : appointments)
//        {
//            LinearLayout card = new LinearLayout(MedicalConsultationActivity.this);
//
//            TextView patientName = new TextView(MedicalConsultationActivity.this);
//            patientName.setText(cm.getName());
//            card.addView(patientName);
//        }
//    }
}