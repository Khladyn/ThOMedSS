...
public class DentalConsultationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseHelper db = new DatabaseHelper(DentalConsultationActivity.this);
        ...
        showNavBar(DentalConsultationActivity.this);
    }
    ...
    private void addActionButtons() {
        ...
        newCase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DentalConsultationActivity.this, ChiefComplaintActivity.class);
                intent.putExtra("caseType", "Dental");
                startActivity(intent);
            }
        });
    }
    ...
    private void showAppointments() {
        ...
        Typeface semibold = ResourcesCompat.getFont(DentalConsultationActivity.this, R.font.poppins_semibold);
        Typeface light = ResourcesCompat.getFont(DentalConsultationActivity.this, R.font.poppins_light);
        ...
        {
            TextView noData = new TextView(DentalConsultationActivity.this);
        ...
        {
            if(cm.getCaseType().equals("Dental")) {

            LinearLayout textContainer = new LinearLayout(DentalConsultationActivity.this);
            textContainer.setOrientation(LinearLayout.VERTICAL);
            textContainer.setPadding(20, 0, 20, 0);

            LinearLayout pillButtonContainer = new LinearLayout(DentalConsultationActivity.this);
            pillButtonContainer.setOrientation(LinearLayout.HORIZONTAL);

            TextView caseNumber = new TextView(DentalConsultationActivity.this);
            ...
            TextView location = new TextView(DentalConsultationActivity.this);
            ...
            TextView patientName = new TextView(DentalConsultationActivity.this);
            ...
            TextView caseDetails = new TextView(DentalConsultationActivity.this);
            ...
            TextView dateCreated = new TextView(DentalConsultationActivity.this);
            ...
            TextView timeQueued = new TextView(DentalConsultationActivity.this);
            ...
            TextView queueStatus = new TextView(DentalConsultationActivity.this);
            ...
            TextView attendingDoctor = new TextView(DentalConsultationActivity.this);
            Spannable textSpan6 = new SpannableString("Attending Dentist   ");
            ...
            View divider = new View(DentalConsultationActivity.this);
